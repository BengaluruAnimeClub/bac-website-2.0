...
export default function Game() {
  ...
  useEffect(() => {
    document.title = "BAC Love Story (Game) | Bengaluru Anime Club (BAC)";
    document.querySelector('meta[name="description"]')?.setAttribute(
      'content',
      "A text-based RPG created with ❤️ by members of the Bengaluru Anime Club (BAC), on the occasion of Valentine's Day 2025. Play through a romantic adventure with multiple endings, featuring original artwork and story paths."
    );
  }, []);
  ...
  return (
    <>
      <Head>
        <title>BAC Love Story (Game)</title>
        <meta name="description" content="A text-based RPG created with ❤️ by members of the Bengaluru Anime Club (BAC), on the occasion of Valentine's Day 2025. Play through a romantic adventure with multiple endings, featuring original artwork and story paths." />
      </Head>
